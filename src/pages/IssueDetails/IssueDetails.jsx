...
const IssueDetails = () => {
  ...
  return (
    <div className="px-20 py-8 to-gray-400">
        <div className="flex justify-between border p-10 rounded-lg">
            <ScrollArea className="h-[80vh] w-[60%]">
                <div>
                    <h1 className="text-lg font-semibold text-gray-400">Create Navigation bar</h1>
                    <div className="py-5">

                        <h2 className="font-semibold text-gray-400">Description</h2>
                        <p className="text-gray-400 text-sm mt-3">
                        Ecommerce is the electronic buying and selling of goods and services, 
                        usually via the internet. Businesses can build their own ecommerce website, 
                    ...
                    <div className="mt-5">
                        ...
                        <Tabs defaultValue="comments" className="w-[400px]">
                            ...
                            <TabsContent value="all">
                                Make all changes on your account here
                            </TabsContent>
                            ...
                            <TabsContent value="history">
                                All History changes on your account here
                            </TabsContent>
                        </Tabs>
                    </div>
                </div>
