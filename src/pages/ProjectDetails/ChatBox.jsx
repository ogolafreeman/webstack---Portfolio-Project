  ...
  return (
    <div className="sticky">
      <div className=" border rounded-lg">
        <h1 className="border-b p-5">Chat with your project members</h1>
          <ScrollArea className="h-[32rem] w-full p-5 flex gap-3 flex-col">
            ...
            <div className="space-y-2 py-2 px-5 border rounded-ss-2xl rounded-e-xl">
                <p>Brunell Atemba</p>
                <p className="text-gray-300">Kindly check on the backend of this project</p>
              </div>
          </div>:
            <div key={item} className="flex gap-2 mb-2 justify-end">
              <div className="space-y-2 py-2 px-5 border rounded-se-2xl rounded-s-xl">
                  <p>Brunell Atemba</p>
                  <p className="text-gray-300">Okay I will</p>
                </div>
                <Avatar>
                <AvatarFallback>
                  B
